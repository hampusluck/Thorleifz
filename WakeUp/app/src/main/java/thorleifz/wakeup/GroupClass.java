...
public class GroupClass {
    ...
    public GroupClass(int status_resource, String group_name, String alarm_time) {
        super();
        this.setStaus_resource(status_resource);
    ...
    public void setStaus_resource(int fruit_resource) {
        this.status_resource = status_resource;
    }
    public String getGroup_name() {
        return group_name;
    }
    public void setGroup_name(String fruit_name) {
        this.group_name = group_name;
    }
    public String getAlarm_time() {
        return alarm_time;
    }
    public void setAlarm_time(String fruit_qty) {
